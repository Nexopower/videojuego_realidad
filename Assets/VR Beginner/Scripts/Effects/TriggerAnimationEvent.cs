...
public class TriggerAnimationEvent : MonoBehaviour
{
    ...
    public void TriggerAnim(SelectEnterEventArgs args)
    {
        ...
        var animator = interactableComponent.GetComponentInChildren<Animator>();
        ...
        var currentLayers = interactableComponent.interactionLayers;
        currentLayers.value &= ~(1<<LayerMask.NameToLayer("Hands"));
        interactableComponent.interactionLayers = currentLayers;
    }
}
